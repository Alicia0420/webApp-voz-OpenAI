...
La app escucha automáticamente al cargarse la página, entra en modo suspendido si no detecta voz durante unos segundos y se reactiva al escuchar la palabra clave **"Lenny"**.
...
Si no detecta una orden válida responde como:
